...
<body>
	...
	<div class="row profil">
		<div class="col-lg-4 col-md-4 col-md-push-1 col-sm-4 col-sm-push-1 col-xs-10 ">
			<h1> <?php echo $prod->naziv;?> <small style="font-size: 0.5em; margin-left: 5%;"><?php echo $prod->kategorija;?></small> <hr/> <h1>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-10 col-md-10 col-md-push-1 col-sm-10 col-sm-push-1">
...
<div class="row">
	<div class="col-lg-10 col-lg-push-1 col-md-10 col-md-push-1 col-sm-10 col-sm-push-1">
	<h1>Kratki opis</h1>
